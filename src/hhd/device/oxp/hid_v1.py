...
# X2 uses a different format marker (0x20 instead of 0x02).
INITIALIZE_X2 = [
    gen_cmd(
        0xB4,
    ...
    gen_cmd(
        0xB4,
        "02382002010a010a0000000b010b0000000c010c0000000d010d0000000e010e0000000f010f000000100110000000220201680000230201690000",
    ),
    gen_intercept(False),
]
