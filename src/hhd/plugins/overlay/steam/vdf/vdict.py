...
From https://github.com/ValvePython/vdf/
"""
import sys
...
if sys.version_info[0] >= 3:
    ...
    class _kView(_c.KeysView):
        def __iter__(self):
            return self._mapping.iterkeys() # type: ignore
    class _vView(_c.ValuesView):
        def __iter__(self):
            return self._mapping.itervalues() # type: ignore
    class _iView(_c.ItemsView):
        def __iter__(self):
            return self._mapping.iteritems() # type: ignore
else:
